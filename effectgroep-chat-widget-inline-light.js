    ...
    const EffectgroepChatLoader = {
        ...
        init: function(userConfig = {}) {
            ...
            if (!this.config.inboxToken) {
                console.error('EffectgroepChat: inboxToken is required');
                return;
            }
            this.createIframe();
        },
        createIframe: function() {
            ...
            container.id = 'effectgroep-chat-widget-container';
            container.style.cssText = 'width:100%;max-width:46rem;margin:0 auto;';
            const iframe = document.createElement('iframe');
            iframe.id = 'effectgroep-chat-iframe';
            iframe.style.cssText = 'width:100%;height:500px;border:none;overflow:visible;background:transparent;';
        ...
        generateIframeContent: function() {
...
:root{--eg-pink:${colors.sendButton};--eg-off-black:#101010;--eg-neutral-darker:#ffffff;--eg-neutral-dark:#ffffff;--eg-white:#2C285E;--eg-text-muted:#CACACA;--eg-font-family:'proxima-nova',-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;}
...
.ai-chat::before,.ai-chat::after{content:"";position:absolute;top:-1px;left:-1px;width:calc(100% + 2px);height:calc(100% + 2px);border-radius:80px;background:linear-gradient(45deg,${glowGradient});background-size:400%;z-index:20;animation:glowbox 20s linear infinite;}
...
.input-container{background-color:var(--eg-neutral-darker);width:100%;height:100%;padding:1rem;position:relative;display:flex;align-items:center;z-index:21;border-radius:80px;overflow:hidden;}
.chat-input{flex:1;background-color:var(--eg-neutral-dark);border:none;outline:none;font-size:1rem;font-weight:500;padding:0 75px 0 2rem;height:100%;color:var(--eg-white);font-family:var(--eg-font-family);z-index:100;position:absolute;inset:0;border-radius:80px;text-overflow:ellipsis;}
...
<body>
    ...
    window.EffectgroepChat = EffectgroepChatLoader;
    EffectgroepChat.init();
})(window, document);
